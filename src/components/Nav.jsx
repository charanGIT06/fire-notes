  ...
  return (
    <>
      <div className={`nav ${theme === 'dark' ? 'dark-theme' : 'light-theme'}`}>
        <div className="big-screens d-none d-md-block w-100 p-2">
          <div className="d-flex flex-row align-items-center w-100 py-3 px-3">
            ...
            <div className={`searchbar w-50 d-flex flex-row align-items-center p-2 ${theme === 'dark' ? 'dark-element' : 'light-element'}`} style={{borderRadius: '25px' }}>
      ...
      <Drawer placement={'left'} onClose={onClose} isOpen={isOpen} className='bg-dark' >
        <DrawerOverlay />
        <DrawerContent>
          <DrawerHeader borderBottomWidth='1px' className={theme === 'dark' ? "dark-theme" : 'light-theme text-dark'} >
            <h4>🔥Fire Notes</h4>
          </DrawerHeader>
          <DrawerBody className={theme === 'dark' ? "dark-theme text-white m-0 p-0" : 'light-theme text-dark m-0 p-0'}>
            <div className="links">
