...
const Profile = () => {
  ...
  const { setActiveNotes, setArchiveNotes, setTrashNotes, setSharedNotes } =
    NotesState();
                ...
                >
                  <CardBody>
                    ...
                    >
                      ...
                      <div
                        className={`section-3 px-3 ${
                          edit ? "d-inline" : "d-none"
                        }`}
                      >
                        <div className='btn-container px-3 pt-2'>
                          <Button
                            className='me-2 round-btn'
                            onClick={() => {
                              setEdit(false);
                            }}
                          >
                  ...
                  <CardBody>
                    <div className='section-3 px-3 pt-2'>
                      <div className='btn-container'>
                        <Button variant='solid' className='me-2 mb-2'>
                          Change Password
                        </Button>
                        <Button
                          variant='solid'
